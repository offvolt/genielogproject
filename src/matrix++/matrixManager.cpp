...
// NO ERROR
    if(matrixA_file && matrixB_file && matrixC_file)
    {
        ...
        // OPERATION
            ...
            else if(cA.getI() < cB.getI() || (cA.getI() == cB.getI() && cA.getJ() < cB.getJ()))       // Cas o� A est trait�
            {
                readA = true;
            ...
            else if(cB.getI() < cA.getI() || (cB.getI() == cA.getI() && cB.getJ() < cA.getJ()))       // Cas o� B est trait�
            {
                readB = true;
...
}	// On fait A+B et on met �a dans matrixOut.
