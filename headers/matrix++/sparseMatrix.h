...
// ******************** CONSTRUCTORS AND DESTRUCTORS *************************** //
	 ...
	 */
	SparseMatrix(string const& fileName); 
	 ...
	 */
	bool newMatrix(unsigned int const& width, unsigned int const& height, string const& fileName);
...
// ************************* MANY FUNCTIONS ************************** //
	 ...
	 */
	void random(unsigned const& int min, unsigned int const& max);
