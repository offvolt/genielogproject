...
public:
	...
	void setMatrix(SparseMatrix &matrixOut);					// Crée une nouvelle matrix si jamais elle n'existe pas.
	SparseMatrix getMatrix(string &matrix);					// Récupère une matrice grâce à son nom.
};
